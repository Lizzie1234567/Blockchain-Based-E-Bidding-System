...
class biddingUser(ANode):
    ...
    def _construct_genesis_block(self):
        self.construct_block(
            proof=42,
            previous_hash="Samira-mira-mira-e-e-Wake-Wake-e-e"
        )
    ...
    def construct_block(self,
        ...
        self.blockchain.store_to_db()  # STORE BLOCKCHAIN TO FILE
